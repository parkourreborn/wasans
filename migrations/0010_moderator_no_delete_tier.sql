-- Introduces a "moderator" tier that can moderate everything (trials and
-- combos) except delete submissions, and renames the previous full-access
-- general moderator tier to "senior moderator". players.permission tiers
-- change from
-- 0 = member, 1 = combo moderator, 2 = moderator (general, full), 3 = owner
-- to
-- 0 = member, 1 = combo moderator, 2 = moderator (general, no delete),
...
-- existing player becomes a plain moderator (2) by this migration -- that
